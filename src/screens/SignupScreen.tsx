...
const SignupScreen = () => {
  ...
  const checkUserExist = async (type: string, value: string | any[]) => {
    if (value?.length > 0) {
...
const styles = StyleSheet.create({
  ...
  featherMargin: {marginRight: 10},
  antMargin: {marginLeft: 5},
});
