...
interface FoodCardProps {
  id: string;
  name: string;
  description: string; // Explicitly specify the type as string
  price: number; // Assuming 'price' is a number, adjust accordingly
  image: string; // Assuming 'image' is a string, adjust accordingly
  navigate: () => void;
}
